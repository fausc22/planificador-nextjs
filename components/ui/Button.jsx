// components/ui/Button.jsx - Componente Button reutilizable
...
const Button = forwardRef(({ 
  ...
  const variants = {
    ...
    outline: 'border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:ring-gray-500',
  };
